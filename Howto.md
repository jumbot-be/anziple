...
#### deployment setup #### 
    ...
    root@ip-172-20-100-11:/opt/ansible# python3 scripts/generate_release_vars.py /opt/SOURCES/4.0.13/checksums  > vars/releases/4.0.13.yml

##### release/source file #####


    root@ip-172-20-100-11:/opt/ansible# cat vars/releases/4.0.13.yml
    apcm_version: 4.0.13
    payara_bundle_version: 5.82.0-4.0.13
    keycloak_bundle_version: 26.4-4.0.13
    nginx_bundle_version: REPLACE_ME
    keycloak_flavor: rh
    mongodb_version: 8.0.16
    artifacts:
    adg_server:
        name: apcm-adg-server-war-4.0.13.war
        url: /opt/SOURCES/4.0.13/backend/apcm-adg-server-war-4.0.13.war
        checksum: sha256:58aaf0569b42c87fcf5079c9c8fc470bd69906c617e04566ef68c383d18a51d2
    apcm_server:
        name: apcm-server-war-4.0.13.war
        url: /opt/SOURCES/4.0.13/backend/apcm-server-war-4.0.13.war
        checksum: sha256:cd4e59b25aefd9f4e7732888325425b6c801396b3ef68df5fae59548f1a32173
    explorer_ear:
        name: ampacimon-explorer-ear-4.0.13.ear
        url: /opt/SOURCES/4.0.13/frontend/ampacimon-explorer-ear-4.0.13.ear
        checksum: sha256:d6a5df239a23388e4edbcf42fe822a220d642fbce70307c381e4d7c529b4533b
    rest_api:
        name: ampacimon-rest-api-ms-4.0.13.war
        url: /opt/SOURCES/4.0.13/frontend/ampacimon-rest-api-ms-4.0.13.war
    ...
    jdk_back_linux:
        ...
        url: /opt/SOURCES/4.0.13/jdk/back/zulu17.62.17-ca-jdk17.0.17-linux_x64.tar.gz
    ...
    jdk_back_windows:
        ...
        url: /opt/SOURCES/4.0.13/jdk/back/zulu17.62.17-ca-jdk17.0.17-win_x64.zip
    ...
    jdk_front_linux:
        ...
        url: /opt/SOURCES/4.0.13/jdk/front/zulu17.66.19-ca-jdk17.0.19-linux_x64.tar.gz
    ...
    jdk_front_windows:
        ...
        url: /opt/SOURCES/4.0.13/jdk/front/zulu17.66.19-ca-jdk17.0.19-win_x64.zip
        checksum: sha256:463c85454c45fd3827df7ccfaa2b14f136eb972387da697a349a42867334328a
    keycloak_rh:
        name: apcm-keycloak-bundle-26.4-4.0.13-Keycloak-RedHat.zip
        url: /opt/SOURCES/4.0.13/keycloak/apcm-keycloak-bundle-26.4-4.0.13-Keycloak-RedHat.zip
        checksum: sha256:c6ad22582ceaf102c0e7aeef7033d86921c266796c0c8022e6a324f704771ced
    keycloak_standard:
        name: apcm-keycloak-bundle-26.4-4.0.13-Keycloak.zip
        url: /opt/SOURCES/4.0.13/keycloak/apcm-keycloak-bundle-26.4-4.0.13-Keycloak.zip
        checksum: sha256:724bcc987aeca755f7a77cda9bff669ef86f32fdc285ed95eebdddf6bba5ed67
    payara:
        name: apcm-payara-bundle-5.82.0-4.0.13-payara-bundle.zip
        url: /opt/SOURCES/4.0.13/payara/apcm-payara-bundle-5.82.0-4.0.13-payara-bundle.zip
...
##### release/source file #####
    ...
    root@ip-172-20-100-11:/opt/ansible# python3 scripts/generate_release_vars.py /opt/SOURCES/4.0.16/checksums  > vars/releases/4.0.16.yml
    root@ip-172-20-100-11:/opt/ansible# cat vars/releases/4.0.16.yml
    apcm_version: 4.0.16
    payara_bundle_version: 5.82.0-4.0.16
    keycloak_bundle_version: 26.4-4.0.17
    nginx_bundle_version: 4.0.16
    keycloak_flavor: rh
    mongodb_version: 8.0.16
    artifacts:
    adg_server:
        name: apcm-adg-server-war-4.0.16.war
        url: /opt/SOURCES/4.0.16/backend/apcm-adg-server-war-4.0.16.war
        checksum: sha256:b45e379c3ee78a77190570c7f7d101df80564a5c353d8989eaf019fb550b8977
    apcm_server:
        name: apcm-server-war-4.0.16.war
        url: /opt/SOURCES/4.0.16/backend/apcm-server-war-4.0.16.war
        checksum: sha256:85f00d465cf0e14583682a01eb0712efeb150d40d0292fbdec49366ebf0279a5
    explorer_ear:
        name: ampacimon-explorer-ear-4.0.16.ear
        url: /opt/SOURCES/4.0.16/frontend/ampacimon-explorer-ear-4.0.16.ear
        checksum: sha256:bb6ad2878126017cb71f6a2bc0ac43421958799ccaa77b1dc0493e89cf980878
    rest_api:
        name: ampacimon-rest-api-ms-4.0.16.war
        url: /opt/SOURCES/4.0.16/frontend/ampacimon-rest-api-ms-4.0.16.war
        checksum: sha256:b4729bee117390696e1966500200421923c4fb33b77a2092d349a8550c1fdd3a
    jdk_back_linux:
        name: zulu17.62.17-ca-jdk17.0.17-linux_x64.tar.gz
        url: /opt/SOURCES/4.0.16/jdk/back/zulu17.62.17-ca-jdk17.0.17-linux_x64.tar.gz
        checksum: sha256:1dcbbed73e95dc35f5c60402a84936f6830ff43c2a0dc0037a5657dbc25472c1
    jdk_back_windows:
        name: zulu17.62.17-ca-jdk17.0.17-win_x64.zip
        url: /opt/SOURCES/4.0.16/jdk/back/zulu17.62.17-ca-jdk17.0.17-win_x64.zip
        checksum: sha256:bd8a942bb543f109a28d3eadf3ec2f29a3ee28ab53506e31d2858292f63c6949
    jdk_front_linux:
        name: zulu17.68.203-ca-jdk17.0.20.1-linux_x64.zip
        url: /opt/SOURCES/4.0.16/jdk/front/zulu17.68.203-ca-jdk17.0.20.1-linux_x64.zip
    ...
    jdk_front_windows:
        ...
        url: /opt/SOURCES/4.0.16/jdk/front/zulu17.68.203-ca-jdk17.0.20.1-win_x64.zip
        checksum: sha256:552a335d5342c800fd03b45a23bb1136f5aa5562193542ece506d8c44b0c60d9
    keycloak_standard:
        name: apcm-keycloak-bundle-26.4-4.0.16-Keycloak.zip
        url: /opt/SOURCES/4.0.16/keycloak/apcm-keycloak-bundle-26.4-4.0.16-Keycloak.zip
        checksum: sha256:c3e6b61b49bec7072be9b856b6be68272c493de428a7d4b2a883684c378fd911
    keycloak_rh:
        name: apcm-keycloak-bundle-26.4-4.0.17-Keycloak-RedHat.zip
        url: /opt/SOURCES/4.0.16/keycloak/apcm-keycloak-bundle-26.4-4.0.17-Keycloak-RedHat.zip
        checksum: sha256:7af1acbd5c2fa66a8abddfc90e6111e9bef402b3782f47573e9d23e3a89bf607
    nginx:
        name: apcm-nginx-bundle-4.0.16-nginx-bundle.zip
        url: /opt/SOURCES/4.0.16/nginx/apcm-nginx-bundle-4.0.16-nginx-bundle.zip
        checksum: sha256:3c903439e19600470e2ef383b823c35682fa574134e9020833ed8b88f1245007
    payara:
        name: apcm-payara-bundle-5.82.0-4.0.16-payara-bundle.zip
        url: /opt/SOURCES/4.0.16/payara/apcm-payara-bundle-5.82.0-4.0.16-payara-bundle.zip
...
### general vars ###
    ...
    include_release_vars: "vars/releases/4.0.16.yml"
...
## RUN 4.0.13 ##
    ...
    ansible-playbook -i inventory/frontend.yml --limit localhost -e @vars/releases/4.0.13.yml deploy.yml
